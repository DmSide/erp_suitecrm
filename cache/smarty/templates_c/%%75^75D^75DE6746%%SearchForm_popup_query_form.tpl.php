...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='filename_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FILENAME','module' => 'Documents'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                

<?php if (strlen ( $this->_tpl_vars['fields']['filename_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['filename_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['filename_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['filename_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['filename_advanced']['name']; ?>
' size='30' 
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Documents'), $this);?>
</label>
                            </div>
            <div class="form-item">
