<?php 
 $GLOBALS["dictionary"]["AOS_Products"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Ответственный инженер',
      'required' => true,
      'source' => 'non-db',
      'name' => 'response_engineer_c',
      'vname' => 'LBL_RESPONSE_ENGINEER',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'AOS_Productsresponse_engineer_c',
    ...
    array (
      ...
      'name' => 'user_id_c',
      'vname' => 'LBL_RESPONSE_ENGINEER_USER_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'AOS_Productsuser_id_c',
      'custom_module' => 'AOS_Products',
    ),
    'inventory_number_s_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Инвентарный номер',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'inventory_number_s_c',
      'vname' => 'LBL_INVENTORY_NUMBER_S',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'AOS_Productsinventory_number_s_c',
      'custom_module' => 'AOS_Products',
    ),
  ),
  'relationships' => 
