 ...
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'document_id_c',
      'vname' => 'LBL_OPPORTUNITIES_DOCUMENTS_C_DOCUMENT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Opportunitiesdocument_id_c',
      'custom_module' => 'Opportunities',
    ),
    'opportunities_documents_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Документы',
      'required' => false,
      'source' => 'non-db',
      'name' => 'opportunities_documents_c',
      'vname' => 'LBL_OPPORTUNITIES_DOCUMENTS_C',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Opportunitiesopportunities_documents_c',
      'custom_module' => 'Opportunities',
    ),
  ),
  'indices' => 
