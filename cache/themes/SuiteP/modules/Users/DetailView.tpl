...
<div class="buttons">
<input title="Править" accessKey="i" name="Edit" id="edit_button" value="Править" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='{$fields.id.value}'; _form.action.value='EditView';_form.submit();" type="button"/>
...
<li><input title="Править" accessKey="i" name="Edit" id="edit_button" value="Править" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='{$fields.id.value}'; _form.action.value='EditView';_form.submit();" type="button"/></li>
...
<li><input title="Установить стандартные значения" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить все настройки данного пользователя?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record={$fields.id.value}';" type="button" name="password" value="Установить стандартные значения"/></li>
<li><input title="Сбросить настройки закладки " ГЛАВНАЯ class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить настройки закладки ГЛАВНАЯ?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record={$fields.id.value}';" type="button" name="password" value="Сбросить настройки закладки "/></li>
