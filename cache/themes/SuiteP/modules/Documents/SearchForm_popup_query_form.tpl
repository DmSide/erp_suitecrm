...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='filename_advanced'>{sugar_translate label='LBL_FILENAME' module='Documents'}</label>
                            </div>
            <div class="form-item">
                                

{if strlen($fields.filename_advanced.value) <= 0}
{assign var="value" value=$fields.filename_advanced.default_value }
{else}
{assign var="value" value=$fields.filename_advanced.value }
{/if}  
<input type='text' name='{$fields.filename_advanced.name}' 
    id='{$fields.filename_advanced.name}' size='30' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Documents'}</label>
                            </div>
            <div class="form-item">
