...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITIES_DOCUMENTS_C' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.opportunities_documents_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.opportunities_documents_c.name}" size="" value="{$fields.opportunities_documents_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.opportunities_documents_c.id_name}" 
id="{$fields.opportunities_documents_c.id_name}" 
value="{$fields.document_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.opportunities_documents_c.name}" id="btn_{$fields.opportunities_documents_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.opportunities_documents_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"document_id_c","document_name":"opportunities_documents_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.opportunities_documents_c.name}" id="btn_clr_{$fields.opportunities_documents_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.opportunities_documents_c.name}', '{$fields.opportunities_documents_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.opportunities_documents_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'document_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_DOCUMENTS_C_DOCUMENT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'opportunities_documents_c', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_DOCUMENTS_C' module='Opportunities' for_js=true}{literal}' );
