...
{capture name="label" assign="label"}{sugar_translate label='LBL_INVENTORY_NUMBER_S' module='AOS_Products'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.inventory_number_s_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.inventory_number_s_c.value) <= 0}
{assign var="value" value=$fields.inventory_number_s_c.default_value }
{else}
{assign var="value" value=$fields.inventory_number_s_c.value }
{/if} 
<span class="sugar_field" id="{$fields.inventory_number_s_c.name}">{$fields.inventory_number_s_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_RESPONSE_ENGINEER' module='AOS_Products'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.response_engineer_c.hidden}
{counter name="panelFieldCount" print=false}

<span id="user_id_c" class="sugar_field" data-id-value="{$fields.user_id_c.value}">{$fields.response_engineer_c.value}</span>
{/if}
