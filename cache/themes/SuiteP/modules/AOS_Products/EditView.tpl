...
{/if}  
<input type='text' name='{$fields.inventory_number_s_c.name}' 
id='{$fields.inventory_number_s_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
<input type="text" name="{$fields.response_engineer_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.response_engineer_c.name}" size="" value="{$fields.response_engineer_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.response_engineer_c.id_name}" 
id="{$fields.response_engineer_c.id_name}" 
value="{$fields.user_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.response_engineer_c.name}" id="btn_{$fields.response_engineer_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_USERS_LABEL"}"
onclick='open_popup(
"{$fields.response_engineer_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id_c","name":"response_engineer_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.response_engineer_c.name}" id="btn_clr_{$fields.response_engineer_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.response_engineer_c.name}', '{$fields.response_engineer_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.response_engineer_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'part_number', 'varchar', true,'{/literal}{sugar_translate label='LBL_PART_NUMBER' module='AOS_Products' for_js=true}{literal}' );
...
addToValidate('EditView', 'response_engineer_c', 'relate', true,'{/literal}{sugar_translate label='LBL_RESPONSE_ENGINEER' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_RESPONSE_ENGINEER_USER_ID' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'inventory_number_s_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_INVENTORY_NUMBER_S' module='AOS_Products' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'response_engineer_c', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='AOS_Products' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_RESPONSE_ENGINEER' module='AOS_Products' for_js=true}{literal}', 'user_id_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_response_engineer_c']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["response_engineer_c","user_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};</script>{/literal}
